...
const ProductCarousel = () => {
  ...
  return (
    <div className="mb-4 lg:block xl:block md:block pt-3">
      {isLoading ? null : error ? (
        ...
        <Slider
          {...settings}
          className="xl:w-[44rem]  lg:w-[44rem] md:w-[56rem] sm:w-[40rem] sm:block"
        >
          {products.map(
            ({
              image,
              ...
              <div key={_id}>
                <img
                  src={image}
                  alt={name}
                  className="w-full rounded-lg object-contain bg-gray-100 h-[30rem] border border-gray-300"
                />
                ...
                <div className="mt-4 flex justify-between">
                  <div className="one">
                    <h2>{name}</h2>
                    <p> $ {price}</p> <br /> <br />
                    <p className="w-[25rem] text-gray-700">
