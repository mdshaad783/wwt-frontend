...
const CategoryList = () => {
  ...
  return (
    <div className='flex flex-col md:flex-row lg:px-16 px-4'>
        <AdminMenu />
        <div className="md:w-3/4 p-3">
            <div className="text-xl font-bold mb-4">Manage Categories</div>
            ...
            <div className="flex flex-wrap gap-3 mt-4">
                {categories?.map((category)=>(
                    <div key={category._id}>
                        <button className="bg-white border border-blue-500 text-blue-500 py-2 px-4 rounded-lg hover:bg-blue-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50" onClick={()=>{{
