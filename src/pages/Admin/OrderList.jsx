...
const OrderList = () => {
  ...
  <>
    {isLoading ? (<Loader/>): error?(
        ...
        <table className='container ml-[3rem] md:ml-[7rem] max-w-[80vw]'>
                ...
                {orders.map((order) => (
                    <tr key={order._id}>
                            ...
                            <td className="py-2">{order.isPaid ? (
                                ...
                                <p className="p-1 text-center bg-red-500 w-[6rem] rounded-full">Pending</p>
                            )}
                            </td>
                            <td className="px-2 py-2">{order.isDelivered ? (
                                <p className="p-1 text-center bg-green-400 w-[6rem] rounded-full">Completed</p>
                            ) : (
                                <p className="p-1 text-center bg-red-500 w-[6rem] rounded-full">Pending</p>
                            )}
